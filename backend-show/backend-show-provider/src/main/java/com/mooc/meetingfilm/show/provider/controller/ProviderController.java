package com.mooc.meetingfilm.show.provider.controller;
...
public class ProviderController {
    ...
    @RequestMapping(value = "/provider/helloApi", method = RequestMethod.GET)
    public String feignTest(String message){

        return "hello, this is hello provider";
    }
